...
import co.aoscp.lunalauncher.search.nano.SearchProto.a_search;
import co.aoscp.lunalauncher.search.nano.SearchProto.b_search;
import co.aoscp.lunalauncher.search.nano.SearchProto.c_search;
import co.aoscp.lunalauncher.search.nano.SearchProto.d_search;
...
public class ConfigBuilder {
    ...
    private final LunaLauncherActivity mActivity;
    ...
    private b_search bZ(final AppInfo appInfo, final int n) {
        ...
        b.el = dm.toString();
        b.ek = new Intent("co.aoscp.lunalauncher.search.APP_LAUNCH", dm.buildUpon().appendQueryParameter("predictionRank", Integer.toString(n)).build()).toUri(0);
        return b;
    }
