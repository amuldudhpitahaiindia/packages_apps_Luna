package co.aoscp.lunalauncher.clock;
...
import co.aoscp.lunalauncher.utils.ActionIntentFilter;
        ...
        try {
            ...
            if (metaData != null) {
                ...
                if (levelPerTickIcon != 0) {
                    ...
                    layers.mHourIndex = metaData.getInt("co.aoscp.lunalauncher.HOUR_LAYER_INDEX", -1);
                    layers.mMinuteIndex = metaData.getInt("co.aoscp.lunalauncher.MINUTE_LAYER_INDEX", -1);
                    layers.mSecondIndex = metaData.getInt("co.aoscp.lunalauncher.SECOND_LAYER_INDEX", -1);
                    layers.mDefaultHour = metaData.getInt("co.aoscp.lunalauncher.DEFAULT_HOUR", 0);
                    layers.mDefaultMinute = metaData.getInt("co.aoscp.lunalauncher.DEFAULT_MINUTE", 0);
                    layers.mDefaultSecond = metaData.getInt("co.aoscp.lunalauncher.DEFAULT_SECOND", 0);
                    if (normalizeIcon) {
