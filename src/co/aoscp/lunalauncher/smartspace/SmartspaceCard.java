package co.aoscp.lunalauncher.smartspace;
...
import co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.b;
import co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.c;
import co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.e;
import co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.i;
import co.aoscp.lunalauncher.utils.ColorManipulation;
...
public class SmartspaceCard {
    ...
    private co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.d cG(final boolean b) {
        final c ch = this.cH();
        if (ch != null) {
            co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.d d;
            if (b) {
                d = ch.cL;
            } else {
                d = ch.cM;
    ...
    private boolean cL(final co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.d d) {
        boolean b = false;
    ...
    private String cO(final boolean b, final String s) {
        final co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.d cg = this.cG(b);
