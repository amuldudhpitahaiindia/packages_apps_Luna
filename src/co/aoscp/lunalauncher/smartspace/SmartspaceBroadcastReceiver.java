...
public class SmartspaceBroadcastReceiver extends BroadcastReceiver {
    ...
    public void onReceive(Context context, Intent intent) {
        byte[] byteArrayExtra = intent.getByteArrayExtra("co.aoscp.lunalauncher.extra.SMARTSPACE_CARD");
        if (byteArrayExtra != null) {
            co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.a a = new co.aoscp.lunalauncher.smartspace.nano.SmartspaceProto.a();
            try {
